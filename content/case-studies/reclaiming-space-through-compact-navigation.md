...
> **TL;DR:** Traditional mobile tab bars reserve screen space at all times, regardless of whether navigation is being used. This concept compresses primary navigation into a compact pill-shaped control that displays only essential information at rest and expands during interaction. The result increases available content space while preserving awareness of application structure, destination access, and spatial consistency.
