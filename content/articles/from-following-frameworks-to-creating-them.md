...
That's when my co-worker said it. We were somewhere in the middle of that reset conversation and he paused and said something like: _"Wait, hold on. So, **what does it do?**"_
...
We sat with it, wrote it down, tried to answer it in one sentence and then two. And then, almost on its own, the companion question surfaced: _what does it not do?_
